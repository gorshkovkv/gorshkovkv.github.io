(function() {
    ...
    function startPlugin() {
      ...
      Lampa.Component.add('lampavod', component); //С‚Рѕ Р¶Рµ СЃР°РјРѕРµ
      resetTemplates();
    ...
    function cdnvideohub(component, _object) {
      ...
      function append(items) {
        ...
        items.forEach(function (element) {
          ...
          var hash_file = Lampa.Utils.hash(element.season ? [element.season, element.season > 10 ? ':' : '', element.episode, object.movie.original_title, element.title, 'cdnvideohub'].join('') : object.movie.original_title + element.quality + 'cdnvideohub');
