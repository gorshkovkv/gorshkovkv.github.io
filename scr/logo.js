            ...
            if (e.type == "complite") {
                ...
                async function findLogo() {
                    ...
                    if (Lampa.Storage.get("logo_glav")) {
                        ...
                        var imgElement = $('<img style="margin-top: 5px; margin-left: 0; max-height: 10%; max-width: 50%; width: auto; height: auto; object-fit: contain; display: block;" src="' + Lampa.TMDB.image("/t/p/w300" + path.replace(".svg", ".png")) + '" />');
