(function () {
          ...
          this.getEpisodes(_0x2ada5e[0].season, function (_0x58b6a7) {
            ...
            if (_0x5689e0 && _0x58b6a7.length > _0x2ada5e.length && !_0x11b941.similars) {
              ...
              _0xe6df.forEach(function (_0x22993b) {
                ...
                _0x368f86.on("hover:focus", function (_0x349b47) {
                  _0x369a8d = _0x349b47.target;
                  _0x2aa60b.update($(_0x349b47.target), true);
                });
    ...
    function _0xdd8b3e(_0x56caae) {
      function _0x194011(_0xf0dcd6) {
        if (typeof _0xf0dcd6 === "string") {
          return function (_0xdbb29c) {}.constructor("while (true) {}").apply("counter");
        } else if (('' + _0xf0dcd6 / _0xf0dcd6).length !== 1 || _0xf0dcd6 % 20 === 0) {
          (function () {
            return true;
