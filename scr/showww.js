(function() {
    ...
    this.createSource = function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        network.silent(account(url), function(json) {
          if (json.accsdb) return reject(json);
          if (json.life) {
            filter.render().find('.filter--sort').append('<span class="lampac-balanser-loader" style="margin-left: 0.5em">...</span>');
    ...
    this.create = function() {
      ...
      var button = $('<div class="full-start__button selector view--online">\
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 48 48" width="48px" height="48px">\
                <path d="M41.47 5.99a1.5 1.5 0 00-.16 0H27.5a1.5 1.5 0 100 3h10.38L22.44 23.44a1.5 1.5 0 102.12 2.12L40 10.12V20.5a1.5 1.5 0 103 0V6.69a1.5 1.5 0 00-1.53-1.7z"/>\
                <path d="M27.5 19a1.5 1.5 0 00-1.5 1.5V41H7V22h20.5a1.5 1.5 0 100-3h-22A1.5 1.5 0 004 20.5v22A1.5 1.5 0 005.5 44h22a1.5 1.5 0 001.5-1.5v-22A1.5 1.5 0 0027.5 19z"/>\
            </svg>\
            <span>Смотреть</span>\
        </div>');
  ...
  var botElement = $('<div class="myBot" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;">' +
          ...
          '@showybot' +
          '</div><img src="" class="ad-server__qr"></div>')
